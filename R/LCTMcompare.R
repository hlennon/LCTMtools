...
LCTMcompare <- function(modelA, modelB) {
                    ...
                    output1 <- t(data.frame("Entropy" = entropy(p), "Relative_entropy" = relative_entropy(p), "BIC" = model$BIC, "AIC" = model$AIC))
                    ...
                    output2 <- t(data.frame("Entropy" = entropy(p), "Relative_entropy" = relative_entropy(p), "BIC" = model$BIC, "AIC" = model$AIC))
